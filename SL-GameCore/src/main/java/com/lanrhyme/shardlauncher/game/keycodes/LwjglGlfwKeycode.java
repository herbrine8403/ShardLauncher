...
package com.lanrhyme.shardlauncher.game.keycodes;
...
public class LwjglGlfwKeycode {
    ...
    /**
     * If this bit is set the Caps Lock key is enabled and the LOCK_KEY_MODS input
     * mode is set.
     */
    public static final int GLFW_MOD_CAPS_LOCK = 0x10;

    /**
     * If this bit is set the Num Lock key is enabled and the LOCK_KEY_MODS input
     * mode is set.
     */
