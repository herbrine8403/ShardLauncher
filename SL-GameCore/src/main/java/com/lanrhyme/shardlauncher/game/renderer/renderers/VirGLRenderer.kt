...
object VirGLRenderer : RendererInterface {
    ...
    override fun getUniqueIdentifier(): String = "c7c8f8e4-8b2a-4f3d-9e1a-2b3c4d5e6f7a"

    override fun getRendererName(): String = "VirGL"

    override fun getRendererSummary(): String = "虚拟化 OpenGL 渲染器，适用于虚拟化环境"
